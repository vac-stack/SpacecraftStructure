...
def hex(R, W, n_s, n_cT, m_sand, rho_panel, h):
...
def circ(R, W, n_s, n_cT, m_sand, rho_panel, h):
...
def square(R, W, n_s, n_cT, m_sand, rho_panel, h):
...
def compare_geom(h):
    ...
    h_hex, area_hex, m_hex = hex(R, W, n_s, n_cT, m_sand, rho_panel, h)
    r_circ, area_circ, m_circ = circ(R, W, n_s, n_cT, m_sand, rho_panel, h)
    w_sq, area_sq, m_sq = square(R, W, n_s, n_cT, m_sand, rho_panel, h)
